...
----------------------------------------------tablascapacitacioncontinua----------------------------

CREATE TABLE  CursoCapacitacionContinua(
	id INT NOT NULL AUTO_INCREMENT,
	nombre VARCHAR(255) NULL,
    descripcion VARCHAR(255) NULL,
PRIMARY KEY (id));

CREATE TABLE  HorarioCapacitacionContinua(
    id INT NOT NULL AUTO_INCREMENT,
	tiempoInicio VARCHAR(255) NULL,
    tiempoFin VARCHAR(255) NULL,
PRIMARY KEY (id));

CREATE TABLE  NivelCapacitacionContinua(
	id INT AUTO_INCREMENT NOT NULL,
	descripcion VARCHAR(255) NULL,
PRIMARY KEY (id));

CREATE TABLE  CicloCapacitacionContinua(
	id 	INT NOT NULL AUTO_INCREMENT,
    descripcion VARCHAR(255) NULL,
    fechaInicio DATETIME NULL,
    fechaFin DATETIME NULL,
...
CREATE TABLE InstruccionCapacitacionContinua(
	id INT AUTO_INCREMENT NOT NULL,
	descripcion VARCHAR(255) NULL,
PRIMARY KEY (id));

CREATE TABLE EmpresaCapacitacionContinua (
	id INT NOT NULL AUTO_INCREMENT,
    ustedTrabaja VARCHAR(20) NULL,
    nombre VARCHAR(255) NULL,
    direccion VARCHAR(255) NULL,
    correo VARCHAR(255) NULL,
    telefono VARCHAR(20) NULL,
    actividad VARCHAR(255) NULL,
    cursoAuspiciado VARCHAR(20) NULL,
    contactoAuspicio VARCHAR(255) NULL,
    enteroCurso VARCHAR(255) NULL,
    otrosCursos VARCHAR(255) NULL,
    PRIMARY KEY (id)
);

CREATE TABLE MatriculaInglesCapacitacionContinua(
	id 	INT NOT NULL AUTO_INCREMENT,
    idNivelCapacitacionContinua INT NULL,
    idHorarioCapacitacionContinua INT NULL,
    idInstruccionCapacitacionContinua INT NULL, 
    idCupoInglesCapacitacionContinua INT NULL,
    idModalidad INT NULL,
    idPersona INT NULL,
PRIMARY KEY (id));


CREATE TABLE RegistroInglesCapacitacionContinua(
	id 	INT NOT NULL AUTO_INCREMENT,
    fecha DATETIME NULL,
    idPeriodoLectivo INT NULL,
    idCicloCapacitacionContinua INT NULL,
    idNivelCapacitacionContinua INT NULL,
    idHorarioCapacitacionContinua INT NULL,
    idCupoCapacitacionContinua INT NULL,    
PRIMARY KEY (id));
