...
@Component({
   selector: 'app-registroinglescapacitacioncontinua',
   templateUrl: './registroinglescapacitacioncontinua.component.html',
   styleUrls: ['./registroinglescapacitacioncontinua.component.scss']
})

export class RegistroInglesCapacitacionContinuaComponent implements OnInit {

   busy: Promise<any>;
   entidades: RegistroInglesCapacitacionContinua[];
   entidadSeleccionada: RegistroInglesCapacitacionContinua;
   pagina: 1;
   tamanoPagina: 20;
   paginaActual: number;
   paginaUltima: number;
   ...
   constructor(public toastr: ToastsManager, vcr: ViewContainerRef, private dataService: RegistroInglesCapacitacionContinuaService, private modalService: NgbModal) {
   ...
   isValid(entidadPorEvaluar: RegistroInglesCapacitacionContinua): boolean {
      return true;
   }
   ...
   crearEntidad(): RegistroInglesCapacitacionContinua {
      const nuevoRegistroInglesCapacitacionContinua = new RegistroInglesCapacitacionContinua();
      nuevoRegistroInglesCapacitacionContinua.id = 0;
      return nuevoRegistroInglesCapacitacionContinua;
   }

   add(entidadNueva: RegistroInglesCapacitacionContinua): void {
   ...
   update(entidadParaActualizar: RegistroInglesCapacitacionContinua): void {
   ...
   delete(entidadParaBorrar: RegistroInglesCapacitacionContinua): void {
   ...
   refresh(): void {
      ...
      this.entidades = RegistroInglesCapacitacionContinua[0];
      this.entidadSeleccionada = this.crearEntidad();
   }
   ...
   onSelect(entidadActual: RegistroInglesCapacitacionContinua): void {
