...
@Component({
   selector: 'app-registrocursoscapacitacioncontinua',
   templateUrl: './registrocursoscapacitacioncontinua.component.html',
   styleUrls: ['./registrocursoscapacitacioncontinua.component.scss']
})

export class RegistroCursosCapacitacionContinuaComponent implements OnInit {

   busy: Promise<any>;
   entidades: RegistroCursosCapacitacionContinua[];
   entidadSeleccionada: RegistroCursosCapacitacionContinua;
   pagina: 1;
   tamanoPagina: 20;
   paginaActual: number;
   paginaUltima: number;
   ...
   constructor(public toastr: ToastsManager, vcr: ViewContainerRef, private dataService: RegistroCursosCapacitacionContinuaService, private modalService: NgbModal) {
   ...
   isValid(entidadPorEvaluar: RegistroCursosCapacitacionContinua): boolean {
      return true;
   }
   ...
   crearEntidad(): RegistroCursosCapacitacionContinua {
      const nuevoRegistroCursosCapacitacionContinua = new RegistroCursosCapacitacionContinua();
      nuevoRegistroCursosCapacitacionContinua.id = 0;
      return nuevoRegistroCursosCapacitacionContinua;
   }

   add(entidadNueva: RegistroCursosCapacitacionContinua): void {
   ...
   update(entidadParaActualizar: RegistroCursosCapacitacionContinua): void {
   ...
   delete(entidadParaBorrar: RegistroCursosCapacitacionContinua): void {
   ...
   refresh(): void {
      ...
      this.entidades = RegistroCursosCapacitacionContinua[0];
      this.entidadSeleccionada = this.crearEntidad();
   }
   ...
   onSelect(entidadActual: RegistroCursosCapacitacionContinua): void {
