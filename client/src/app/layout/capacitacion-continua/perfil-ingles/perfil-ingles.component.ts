...
import {NivelCapacitacionContinuaService} from 'app/layout/capacitacion-continua/nivelcapacitacioncontinua/nivelcapacitacioncontinua.service';
...
import {NivelCapacitacionContinua} from 'app/entidades/CRUD/NivelCapacitacionContinua';
...
@Component({
    selector: 'app-perfil-ingles',
    templateUrl: './perfil-ingles.component.html',
    styleUrls: ['./perfil-ingles.component.scss']
})
export class PerfilInglesComponent implements OnInit {
    ...
    generos: Genero[] = [];
    niveles: NivelCapacitacionContinua[] = [];
    ...
    ngOnInit() {
        ...
        this.hablaIdiomaAncestral1 = false;
        ...
        this.busy = this.nivelDataService.getAll()
            .then(respuesta => {
        ...
        if (this.personaLogeada.hablaIdiomaAncestral === 'true') {
            this.hablaIdiomaAncestral1 = true;
        } else {
            this.hablaIdiomaAncestral1 = false;
            this.personaLogeada.hablaIdiomaAncestral = 'false';
        }
    ...
    HablaIdiomaAncestral1() {
        if (this.hablaIdiomaAncestral1) {
             this.hablaIdiomaAncestral1 = false;
            this.personaLogeada.hablaIdiomaAncestral = 'false';
            this.personaLogeada.idiomaAncestral = '';
        } else {
             this.hablaIdiomaAncestral1 = true;
            this.personaLogeada.hablaIdiomaAncestral
             = 'true';
        }
    }
