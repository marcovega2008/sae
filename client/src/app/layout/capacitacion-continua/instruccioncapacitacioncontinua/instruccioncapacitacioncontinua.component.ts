...
@Component({
   selector: 'app-instruccioncapacitacioncontinua',
   templateUrl: './instruccioncapacitacioncontinua.component.html',
   styleUrls: ['./instruccioncapacitacioncontinua.component.scss']
})

export class InstruccionCapacitacionContinuaComponent implements OnInit {

   busy: Promise<any>;
   entidades: InstruccionCapacitacionContinua[];
   entidadSeleccionada: InstruccionCapacitacionContinua;
   pagina: 1;
   tamanoPagina: 20;
   paginaActual: number;
   paginaUltima: number;
   ...
   constructor(public toastr: ToastsManager, vcr: ViewContainerRef, private dataService: InstruccionCapacitacionContinuaService, private modalService: NgbModal) {
   ...
   isValid(entidadPorEvaluar: InstruccionCapacitacionContinua): boolean {
      return true;
   }
   ...
   crearEntidad(): InstruccionCapacitacionContinua {
      const nuevoInstruccionCapacitacionContinua = new InstruccionCapacitacionContinua();
      nuevoInstruccionCapacitacionContinua.id = 0;
      return nuevoInstruccionCapacitacionContinua;
   }

   add(entidadNueva: InstruccionCapacitacionContinua): void {
   ...
   update(entidadParaActualizar: InstruccionCapacitacionContinua): void {
   ...
   delete(entidadParaBorrar: InstruccionCapacitacionContinua): void {
   ...
   refresh(): void {
      ...
      this.entidades = InstruccionCapacitacionContinua[0];
      this.entidadSeleccionada = this.crearEntidad();
   }
   ...
   onSelect(entidadActual: InstruccionCapacitacionContinua): void {
