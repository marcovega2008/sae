...
@Component({
   selector: 'app-ciclocapacitacioncontinua',
   templateUrl: './ciclocapacitacioncontinua.component.html',
   styleUrls: ['./ciclocapacitacioncontinua.component.scss']
})

export class CicloCapacitacionContinuaComponent implements OnInit {

   busy: Promise<any>;
   entidades: CicloCapacitacionContinua[];
   entidadSeleccionada: CicloCapacitacionContinua;
   pagina: 1;
   tamanoPagina: 20;
   paginaActual: number;
   paginaUltima: number;
   ...
   constructor(public toastr: ToastsManager, vcr: ViewContainerRef, private dataService: CicloCapacitacionContinuaService, private modalService: NgbModal) {
   ...
   isValid(entidadPorEvaluar: CicloCapacitacionContinua): boolean {
      return true;
   }
   ...
   crearEntidad(): CicloCapacitacionContinua {
      const nuevoCicloCapacitacionContinua = new CicloCapacitacionContinua();
      nuevoCicloCapacitacionContinua.id = 0;
      return nuevoCicloCapacitacionContinua;
   }

   add(entidadNueva: CicloCapacitacionContinua): void {
   ...
   update(entidadParaActualizar: CicloCapacitacionContinua): void {
   ...
   delete(entidadParaBorrar: CicloCapacitacionContinua): void {
   ...
   refresh(): void {
      ...
      this.entidades = CicloCapacitacionContinua[0];
      this.entidadSeleccionada = this.crearEntidad();
   }
   ...
   onSelect(entidadActual: CicloCapacitacionContinua): void {
