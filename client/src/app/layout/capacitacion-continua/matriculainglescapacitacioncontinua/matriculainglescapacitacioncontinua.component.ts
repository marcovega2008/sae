...
@Component({
   selector: 'app-matriculainglescapacitacioncontinua',
   templateUrl: './matriculainglescapacitacioncontinua.component.html',
   styleUrls: ['./matriculainglescapacitacioncontinua.component.scss']
})

export class MatriculaInglesCapacitacionContinuaComponent implements OnInit {

   busy: Promise<any>;
   entidades: MatriculaInglesCapacitacionContinua[];
   entidadSeleccionada: MatriculaInglesCapacitacionContinua;
   pagina: 1;
   tamanoPagina: 20;
   paginaActual: number;
   paginaUltima: number;
   ...
   constructor(public toastr: ToastsManager, vcr: ViewContainerRef, private dataService: MatriculaInglesCapacitacionContinuaService, private modalService: NgbModal) {
   ...
   isValid(entidadPorEvaluar: MatriculaInglesCapacitacionContinua): boolean {
      return true;
   }
   ...
   crearEntidad(): MatriculaInglesCapacitacionContinua {
      const nuevoMatriculaInglesCapacitacionContinua = new MatriculaInglesCapacitacionContinua();
      nuevoMatriculaInglesCapacitacionContinua.id = 0;
      return nuevoMatriculaInglesCapacitacionContinua;
   }

   add(entidadNueva: MatriculaInglesCapacitacionContinua): void {
   ...
   update(entidadParaActualizar: MatriculaInglesCapacitacionContinua): void {
   ...
   delete(entidadParaBorrar: MatriculaInglesCapacitacionContinua): void {
   ...
   refresh(): void {
      ...
      this.entidades = MatriculaInglesCapacitacionContinua[0];
      this.entidadSeleccionada = this.crearEntidad();
   }
   ...
   onSelect(entidadActual: MatriculaInglesCapacitacionContinua): void {
