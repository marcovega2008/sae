...
@Component({
   selector: 'app-cupoinglescapacitacioncontinua',
   templateUrl: './cupoinglescapacitacioncontinua.component.html',
   styleUrls: ['./cupoinglescapacitacioncontinua.component.scss']
})

export class CupoInglesCapacitacionContinuaComponent implements OnInit {

   busy: Promise<any>;
   entidades: CupoInglesCapacitacionContinua[];
   entidadSeleccionada: CupoInglesCapacitacionContinua;
   pagina: 1;
   tamanoPagina: 20;
   paginaActual: number;
   paginaUltima: number;
   ...
   constructor(public toastr: ToastsManager, vcr: ViewContainerRef, private dataService: CupoInglesCapacitacionContinuaService, private modalService: NgbModal) {
   ...
   isValid(entidadPorEvaluar: CupoInglesCapacitacionContinua): boolean {
      return true;
   }
   ...
   crearEntidad(): CupoInglesCapacitacionContinua {
      const nuevoCupoInglesCapacitacionContinua = new CupoInglesCapacitacionContinua();
      nuevoCupoInglesCapacitacionContinua.id = 0;
      return nuevoCupoInglesCapacitacionContinua;
   }

   add(entidadNueva: CupoInglesCapacitacionContinua): void {
   ...
   update(entidadParaActualizar: CupoInglesCapacitacionContinua): void {
   ...
   delete(entidadParaBorrar: CupoInglesCapacitacionContinua): void {
   ...
   refresh(): void {
      ...
      this.entidades = CupoInglesCapacitacionContinua[0];
      this.entidadSeleccionada = this.crearEntidad();
   }
   ...
   onSelect(entidadActual: CupoInglesCapacitacionContinua): void {
