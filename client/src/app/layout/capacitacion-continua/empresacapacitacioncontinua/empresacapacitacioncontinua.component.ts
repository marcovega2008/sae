...
@Component({
   selector: 'app-empresacapacitacioncontinua',
   templateUrl: './empresacapacitacioncontinua.component.html',
   styleUrls: ['./empresacapacitacioncontinua.component.scss']
})

export class EmpresaCapacitacionContinuaComponent implements OnInit {

   busy: Promise<any>;
   entidades: EmpresaCapacitacionContinua[];
   entidadSeleccionada: EmpresaCapacitacionContinua;
   pagina: 1;
   tamanoPagina: 20;
   paginaActual: number;
   paginaUltima: number;
   ...
   constructor(public toastr: ToastsManager, vcr: ViewContainerRef, private dataService: EmpresaCapacitacionContinuaService, private modalService: NgbModal) {
   ...
   isValid(entidadPorEvaluar: EmpresaCapacitacionContinua): boolean {
      return true;
   }
   ...
   crearEntidad(): EmpresaCapacitacionContinua {
      const nuevoEmpresaCapacitacionContinua = new EmpresaCapacitacionContinua();
      nuevoEmpresaCapacitacionContinua.id = 0;
      return nuevoEmpresaCapacitacionContinua;
   }

   add(entidadNueva: EmpresaCapacitacionContinua): void {
   ...
   update(entidadParaActualizar: EmpresaCapacitacionContinua): void {
   ...
   delete(entidadParaBorrar: EmpresaCapacitacionContinua): void {
   ...
   refresh(): void {
      ...
      this.entidades = EmpresaCapacitacionContinua[0];
      this.entidadSeleccionada = this.crearEntidad();
   }
   ...
   onSelect(entidadActual: EmpresaCapacitacionContinua): void {
