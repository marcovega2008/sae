...
@Component({
   selector: 'app-nivelcapacitacioncontinua',
   templateUrl: './nivelcapacitacioncontinua.component.html',
   styleUrls: ['./nivelcapacitacioncontinua.component.scss']
})

export class NivelCapacitacionContinuaComponent implements OnInit {

   busy: Promise<any>;
   entidades: NivelCapacitacionContinua[];
   entidadSeleccionada: NivelCapacitacionContinua;
   pagina: 1;
   tamanoPagina: 20;
   paginaActual: number;
   paginaUltima: number;
   ...
   constructor(public toastr: ToastsManager, vcr: ViewContainerRef, private dataService: NivelCapacitacionContinuaService, private modalService: NgbModal) {
   ...
   isValid(entidadPorEvaluar: NivelCapacitacionContinua): boolean {
      return true;
   }
   ...
   crearEntidad(): NivelCapacitacionContinua {
      const nuevoNivelCapacitacionContinua = new NivelCapacitacionContinua();
      nuevoNivelCapacitacionContinua.id = 0;
      return nuevoNivelCapacitacionContinua;
   }

   add(entidadNueva: NivelCapacitacionContinua): void {
   ...
   update(entidadParaActualizar: NivelCapacitacionContinua): void {
   ...
   delete(entidadParaBorrar: NivelCapacitacionContinua): void {
   ...
   refresh(): void {
      ...
      this.entidades = NivelCapacitacionContinua[0];
      this.entidadSeleccionada = this.crearEntidad();
   }
   ...
   onSelect(entidadActual: NivelCapacitacionContinua): void {
