...
@Component({
    selector: 'app-perfil-cursos',
    templateUrl: './perfil-cursos.component.html',
    styleUrls: ['./perfil-cursos.component.scss']
})
export class PerfilCursosComponent implements OnInit {
